    ...
    <>
      <div className="  text-center rounded-lg text-white font-bold">
        <button
          type="button"
          onClick={openModal}
          className="w-full  bg-red-400 hover:bg-transparent hover:text-red-400 hover:border border-red-400 py-2 text-center rounded-lg text-white font-bold active:scale-90 "
        >
          Buy Now
        </button>
      </div>
